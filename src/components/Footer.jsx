...
function Footer() {
  return (
    <div className="w-full h-full  flex gap-[15vw] py-[5vw]  px-[4vw] bg-zinc-900">
      ...
      <div className="w-1\2">
        ...
        <br />
        <div className="links flex justify-between  uppercase font-['Neue-Montreal'] ">
          <div className=" left ">
            <div className="dets">
            ...
            <div className="dets">
              ...
              <a className="block pt-2 text-sm" href="#">
