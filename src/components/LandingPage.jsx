...
function LandingPage() {
  return (
    ...
    >
      <div className="textHead mt-40 px-[4.5vw] font-['Neue-Montreal'] ">
      ...
      <div className="border-t-[1px] border-zinc-800 mt-32 flex justify-between items-center py-5 px-[4.5vw]">
        ...
        <div className="start flex  items-center gap-1">
          <div className="group hover:bg-white hover:text-black transition-colors duration-300   px-[0.5vw] py-[0.3vw] border-[1.5px] border-black font-light  rounded-full">
            <h1 className=" rounded text-base"> START THE PROJECT</h1>
          </div>
          <div className=" group hover:bg-black transition-colors duration-300  w-[2.4vw] h-[2.4vw] flex items-center justify-center  border-[1.5px]  border-black rounded-full">
